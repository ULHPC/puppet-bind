...
By default, the [puppet-bind](https://github.com/ULHPC/puppet-bind) repository is bound to the [ulhpc-puppet-bind](http://ulhpc-puppet-bind.rtfd.org) project on Read the Docs (to avoid confusion with other bind projects). 
